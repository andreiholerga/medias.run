...
export default function Home() {
  return (
    <main>
      ...
      <section className="relative h-[85vh] min-h-[480px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full px-6 md:px-12 pb-16 md:pb-20">
          ...
          <p className="text-paper/80 max-w-lg text-base md:text-lg mb-8">
            O comunitate unită de pasiune, energie și dorința de a fi mai buni în fiecare zi.
          </p>
          <Link
            to="/trasee"
      ...
      {/* EVENIMENTE */}
      <section id="evenimente" className="max-w-6xl mx-auto px-6 py-16 md:py-20">
      ...
      <section id="despre-noi" className="border-t border-ink/10 bg-white/40">
        <div className="max-w-3xl mx-auto px-6 py-16 md:py-20">
          ...
          <p className="text-ink/70 text-lg mb-5 leading-relaxed">
            <strong className="text-ink">Binderbubi Backyard Running</strong> nu este doar un grup de
            alergare, ci o comunitate vibrantă care te invită să descoperi bucuria mișcării autentice.
            Ne întâlnim periodic pentru a explora potecile pitorești din zona Mediașului.
          </p>
          <p className="text-ink/70 text-lg mb-8 leading-relaxed">
            Credem că dealurile și traseele stradale sunt pentru toată lumea. Organizăm sesiuni
            adaptate pentru <strong className="text-ink">toate nivelurile de experiență</strong>.
          </p>
          ...
          <div className="border-y border-ink/10 py-8">
            ...
            <ul className="space-y-4">
              {[
                ["Depășește-ți limitele:", "Într-un cadru prietenos, provocările devin realizări."],
                ["Energie pură:", "Atmosfera de grup te va face să uiți de oboseală."],
                ["Natură și comunitate:", "Descoperi locuri noi alături de oameni pasionați."],
                ["Zero presiune:", "Punem preț pe camaraderie și stare de bine."],
              ].map(([bold, rest]) => (
          ...
          <p className="text-ink/70 text-lg mt-8 leading-relaxed">
            Vino să simți energia „curții noastre din spate”! Te așteptăm să scriem împreună
            următorul kilometru.
          </p>
        </div>
      </section>
      ...
      {/* ACTIVITATE */}
      <section id="activitate" className="max-w-6xl mx-auto px-6 py-16 md:py-20">
        <h2 className="font-display text-3xl md:text-4xl font-black uppercase mb-10">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          >
            <span className="text-trail font-mono text-xs tracking-widest uppercase">Eveniment anual</span>
            <h3 className="font-display text-2xl font-black uppercase mt-2 mb-3">Autism 24h</h3>
            <p className="text-ink/70 mb-6">
              Alergăm 24 de ore non-stop pentru a susține copiii cu autism. Un test de anduranță
          ...
          >
            <span className="text-trail-light font-mono text-xs tracking-widest uppercase">Săptămânal</span>
            <h3 className="font-display text-2xl font-black uppercase mt-2 mb-3">Alergări în grup</h3>
            <p className="text-paper/70 mb-6">
              Explorăm împreună Mediașul și împrejurimile, alternând asfaltul cu trail-ul.
            </p>
            <span className="font-display font-bold text-trail-light">Vezi programul pe Facebook →</span>
          </a>
        </div>
      </section>
      ...
      <section id="contact" className="border-t border-ink/10">
        <div className="max-w-2xl mx-auto px-6 py-16 md:py-20 text-center">
          ...
          <p className="text-ink/70 text-lg mb-8">
            Ai întrebări despre trasee sau vrei să te alături grupului? Contactează-ne oricând:
          </p>
